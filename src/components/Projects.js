  ...
  const projects = [
    {
      ...
      title: "MockMate",
      description:
        "AI-powered interview simulator that helps candidates prepare with mock interviews and personalized feedback using advanced AI technology.",
    ...
    },
    {
      ...
      title: "DevInsight",
      description:
        "GitHub repository analyzer powered by GPT that provides detailed insights, code quality assessment, and improvement suggestions.",
      image: "/api/placeholder/400/250",
